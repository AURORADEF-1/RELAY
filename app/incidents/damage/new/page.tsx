...
export default function NewDamageIncidentPage() {
          ...
          <section className="rounded-[2rem] border border-white/80 bg-white/90 p-8 shadow-[0_28px_80px_-32px_rgba(15,23,42,0.35)] backdrop-blur sm:p-10">
            <div className="space-y-5">
              ...
              <p className="max-w-3xl text-base leading-8 text-slate-600">
                Use this form to capture workshop damage reports separately from the parts request workflow.
              </p>
            </div>

            <div className="mt-8">
              <WorkshopIncidentsTabs activeTab="damage" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 grid gap-6 lg:grid-cols-2">
              ...
              <Field label="Damage Area" value={formState.damage_area} onChange={(value) => setFormState((current) => ({ ...current, damage_area: value }))} />
              ...
              <div className="lg:col-span-2 flex justify-end">
                ...
                >
                  {isSubmitting ? "Saving..." : "Create Damage Report"}
                </button>
              </div>
            </form>
          </section>
